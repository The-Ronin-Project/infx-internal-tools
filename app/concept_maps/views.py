...
def create_mappings_helper(
    source_concept_uuids,
    relationship_code_uuid,
    target_concept_code,
    target_concept_display,
    target_concept_terminology_version_uuid,
...
def create_mappings():
    if request.method == "POST":
        # extract and validate parameters from request.json
        ...
        new_mappings = create_mappings_helper(
            source_concept_uuids,
            relationship_code_uuid,
            target_concept_code,
            target_concept_display,
