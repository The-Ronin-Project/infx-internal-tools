...
from app.helpers.format_helper import filter_unsafe_depends_on_value, prepare_depends_on_value_for_storage, \
    DataExtensionUrl, prepare_code_and_display_for_storage, \
...
'f469524c-83fa-461c-976d-4e4a818713f8'
    ...
    def test_prepare_code_and_display_for_storage_spark_with_text_only_real_case(self):
        code = "{Line 1}"
    ...
    def test_prepare_code_and_display_for_storage_spark_with_text_only_fake_case(self):
        code = "{anything}"
    ...
    def test_prepare_code_and_display_for_storage_spark_with_commas_in_display(self):
    ...
    def test_prepare_code_and_display_for_storage_spark_with_long_coding_list(self):
